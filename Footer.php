      ...
      <div class="container text-center text-white-50 text-md-start mt-5 pt-2">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="CartPage.php" class="text-reset text-underline-hover">Cart</a>
            </p>
            <p>
            ...
            <p>
              <a href="contactus.php" class="text-reset text-underline-hover">Contact us</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <p>
              <a href="contact us.php" class="text-reset text-underline-hover" style="padding-left: 33px;">Contact
                us</a>
            </p>
          </div>
          <!-- Grid column -->
