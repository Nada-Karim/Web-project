...
$sql = "SELECT `BookID`,AuthorID, `BookImg`, `BookName`, `BookPrice`, `BookDesc`, `BookRating` FROM `books` ";
   ...
   <div class="container text-center text-white-50 text-md-start mt-5 pt-2">
     ...
     <div class="row mt-3">
       ...
       <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
         ...
         <p>
           <a href="#!" class="text-reset text-underline-hover">Cart</a>
         </p>
         ...
         <p>
          <a href="authors page.html" class="text-reset text-underline-hover">Authors</a>
        </p>
         <p>
           <a href="about us.html" class="text-reset text-underline-hover">About us</a>
